...
func RegisterActivity_LogServer(s *grpc.Server, srv Activity_LogServer) {
	s.RegisterService(&_Activity_Log_serviceDesc, srv)
}
...
var _Activity_Log_serviceDesc = grpc.ServiceDesc{
